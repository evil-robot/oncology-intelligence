  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-background flex flex-col">
      ...
      <header className="flex-shrink-0 border-b border-border px-6 py-3 flex items-center justify-between relative z-50 bg-surface/30">
        ...
        <div className="flex items-center gap-4">
          <a href="/story-builder/board" className="text-xs text-violet-400 hover:text-white transition-colors border border-violet-500/20 rounded-md px-3 py-1.5 hover:border-violet-500/40 hidden md:inline-flex items-center gap-1.5">
            <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7" /></svg>
            Board
          </a>
          <StatsBar />
          <ExplainerPanel />
